        ...
        <div className="animate-fade-in" style={{ padding: '2rem', minHeight: '100vh' }}>
            ...
            <header style={{
                ...
                <div style={{ display: 'flex', gap: '1rem' }}>
                    <button className="btn-secondary" onClick={onBack}>← New Upload</button>
                    <button className="btn-primary" onClick={onSave}>💾 Save to Dashboard</button>
                </div>
            </header>
                ...
                <div className="animate-fade-in" id="notes-content">
                    <div className="glass-card">
                        <div style={{
                            ...
                            <h3 style={{ fontSize: '1.2rem', fontWeight: 700 }}>📝 Structured Notes</h3>
                ...
                <div className="animate-fade-in" style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }} id="summary-content">
                    ...
                    {summary.overview && (
                        <div className="glass-card" style={{ padding: '1.5rem' }}>
                            <h3 style={{ fontSize: '1.2rem', marginBottom: '1rem', fontWeight: 700 }}>📋 Overview</h3>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem' }}>
                        ...
                        <div className="glass-card" style={{ display: 'flex', flexDirection: 'column' }}>
                            <div style={{ padding: '1.5rem', borderBottom: '1px solid var(--glass-border)' }}>
                                <h3 style={{ fontSize: '1.1rem', fontWeight: 700 }}>⭐ Key Highlights</h3>
                            </div>
                        ...
                        <div className="glass-card" style={{ display: 'flex', flexDirection: 'column' }}>
                            <div style={{ padding: '1.5rem', borderBottom: '1px solid var(--glass-border)' }}>
                                <h3 style={{ fontSize: '1.1rem', fontWeight: 700 }}>🎯 Important Concepts</h3>
                            </div>
                            <div className="scroll-area" style={{ flex: 1 }}>
                    ...
                    {summary.keyFormulas && Array.isArray(summary.keyFormulas) && summary.keyFormulas.length > 0 && (
                        <div className="glass-card" style={{ padding: '1.5rem' }}>
                            <h3 style={{ fontSize: '1.1rem', marginBottom: '1rem', fontWeight: 700 }}>🔢 Key Formulas & Equations</h3>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem' }}>
                        ...
                        {summary.keyTakeaway && (
                            <div className="glass-card" style={{ padding: '1.5rem', borderLeft: '3px solid var(--accent)' }}>
                                <h3 style={{ fontSize: '1.1rem', marginBottom: '1rem', fontWeight: 700 }}>🏆 Key Takeaway</h3>
                                <p style={{
